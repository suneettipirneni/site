...
tags:
  - concepts
headerStyle: "contain"
headingImage: "/headers/type-gradient.png"
headingImageDark: "/headers/type-gradient-dark.png"
...
<Quote>
  "The issue with loosely typed languages is more subtle, (...) Each error is a cut to your productivity, and while each cut is small,
the combined effect is a much larger productivity sinkhole."
</Quote>
...
```typescript
const snowflakeFromDb = (await db.query('SELECT id FROM users WHERE name = "Suneet"')) as Snowflake
```
...
symbol without having to leave their editor. Even better, if you use statically typed languages your users get this for free.  
