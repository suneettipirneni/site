...
description: Don't do more work unless you need to. Sometimes arrays aren't the best data structure for the job, and that's okay.
---
...
![alt text](/assets/array-diagram.png "A visual representation of continuous memory.")
...
![alt text](/assets/iterator-diagram.png "A visual representation of non-continuous memory via an iterator.")
