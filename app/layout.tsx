...
export default function RootLayout({
  ...
  return (
    <html lang="en" style={{ fontFeatureSettings: "cv02, cv03, cv04, cv11" }}>
      ...
      <body
        className={`${inter.className} ${jetBrainsMono.variable} dark:text-white text-black mx-auto h-screen flex flex-col items-center bg-gray-50 dark:bg-zinc-950 bg-150 bg-cover bg-no-repeat w-full md:pt-5 md:px-5 max-w-[1000px] py-2 px-2`}
      >
        <TabBar
          tabs={[
